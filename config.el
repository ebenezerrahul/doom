...
;; Set transparency for the current and future frames
...
;; (after! doom-themes
;;   (unless (display-graphic-p)
;;     (dolist (face '(default fringe mode-line modeline-inactive))
;;       (set-face-attribute face nil :background "unspecified-bg")
;;       )
;;     )
;;   )
